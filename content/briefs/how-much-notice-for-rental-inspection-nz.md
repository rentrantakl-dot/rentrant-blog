...
faqs:
  - question: "How much notice does a landlord have to give for a routine inspection in NZ?"
    answer: "At least 48 hours and no more than 14 days written notice, under section 48 of the Residential Tenancies Act 1986. The notice must state the date, time (between 8am and 7pm), and reason for entry."
...
A valid inspection notice must be **in writing** — email and text both count — and must state:

- The **date** of the inspection
- The **time** (must be between 8am and 7pm)
- The **reason** for entry

A vague "we'll be by sometime next week" is not proper notice. Neither is a verbal heads-up at the letterbox.
...
Most landlords run inspections every three to six months. The four-week cap is the legal ceiling, not the norm — if you're being inspected fortnightly with no specific reason, that's worth raising.

---

## What Counts as a Different Type of Entry

The notice rules vary depending on why the landlord wants in:
...
## If the Notice Isn't Right

You're not legally required to let your landlord in for an inspection that doesn't comply with the notice rules. The cleanest response is in writing:

> Hi [Landlord/Property Manager],
>
> Thanks for the message. Under section 48 of the Residential Tenancies Act, inspection notices need to be at least 48 hours in advance and state the date, time, and reason. Could you re-send the notice with those details so we can confirm a suitable time?
>
> Cheers,
> [Your name]
...
Had a property manager show up unannounced or inspect too often? [Add your experience to RentRant](https://rentrant.nz/locations/search) — it tells the next renter what they're walking into. Free, sign in with Google, about a minute.
