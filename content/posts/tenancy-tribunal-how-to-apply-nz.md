...
|---|---|
| Healthy Homes non-compliance | Compliance order, rent reduction, exemplary damages |
| Maintenance failure | Compliance order, compensation, exemplary damages |
| Bond dispute | Bond refund order |
| Unlawful rent increase | Reduction, repayment of overpaid rent |
| Unlawful landlord entry | Exemplary damages |
| Harassment | Exemplary damages |
| Retaliatory termination | Termination declared void |

---

## Before you apply: build your evidence

The Tribunal makes decisions based on evidence. Your account of events matters — but documented evidence is what wins cases.

Before filing, gather:

- **All written communication** with your landlord or property manager — emails, texts, any written requests for repairs. Screenshot everything and save it somewhere you control (not just your phone).
- **Photos with timestamps** — mould, damp, broken fixtures, anything relevant. Your phone's camera timestamps photos automatically.
- **Your tenancy agreement** — the signed copy.
- **The Healthy Homes compliance statement** — your landlord must provide this within 21 days of tenancy start. If you never received one, that itself is a breach.
- **Rent payment records** — bank statements showing your payments.
- **Any inspection reports** or property condition reports from the start of tenancy.

> **Tip:** If you haven't already put your complaint in writing, do it now — before filing. A written record of what you asked for and when is far more useful at the Tribunal than "I told them about it three months ago." Even a text message chain is something. A documented email trail is better.
...
Apply at any Tenancy Services office. Find your nearest at [tenancy.govt.nz](https://www.tenancy.govt.nz/).

### Writing your narrative

The application asks you to describe the dispute. Keep it factual and chronological:

- What the problem is
- When it started
- What you asked the landlord to do (with dates)
- What the landlord said or did in response
- What's still unresolved

Don't editoralise. "My landlord is terrible and doesn't care" won't help you; "I sent written requests on [date] and [date] with no response" will.
...
Most cases go to free mediation first — usually within **2–6 weeks** of your application being filed, though this varies with caseload.

A Tenancy Services mediator contacts both parties separately, then brings you together (by phone, video, or in person). The mediator's job is to help both sides reach an agreement — they don't decide the case, they facilitate the conversation.

If you reach an agreement, it's written up as a binding Tenancy Tribunal order. Both parties must comply with it.

Many cases resolve at this stage, which is usually faster and less adversarial than a hearing. If you're owed something reasonable and there's clear evidence, mediation often gets there.

### Stage 2: Hearing

If mediation doesn't resolve the dispute, the case goes to a Tribunal hearing. Timelines vary — **typically 2–4 months** from your application, depending on the Tribunal's workload.
...
A first-time maintenance failure that the landlord eventually fixes is unlikely to attract significant damages. A landlord who ignored three written requests about a mould problem for six months is in different territory.
...
— the tenant can apply to the Tribunal to have the termination declared retaliatory and void.

> **Key point:** The protection doesn't prevent a landlord from issuing notice — it gives you the right to challenge it. The burden of proof is on you to show the connection. This is why the timeline matters: document when you complained, when you applied to the Tribunal, and when the notice arrived. A termination notice that arrives the week after a maintenance complaint is exactly what this protection is designed for.

---

## You don't have to do this alone

Most people who use the Tribunal represent themselves. The process is designed for it. But if you want help preparing:

- **Community Law NZ** — free legal advice centres around the country. They'll look at your case with you, help you understand your options, and can review your application before you file. [communitylaw.org.nz](https://communitylaw.org.nz/)
- **Citizens Advice Bureau** — free guidance on the process, next steps, and what to expect. [cab.org.nz](https://www.cab.org.nz/)
- **Tenancy Services helpline** — 0800 836 262. They'll explain the process but can't represent you or advise on strategy.

None of these require you to commit to filing. Getting advice first is sensible.

---

## A note on fixed-term tenancies

The process above applies to both periodic and fixed-term tenancies. But the types of disputes are sometimes different. During a fixed term, a landlord generally can't end the tenancy before the term expires except in specific circumstances (abandonment, serious breach). At the end of a fixed term, different notice rules apply.

If your dispute is about whether a fixed-term tenancy was ended lawfully, get advice from Community Law before filing — the facts matter.
